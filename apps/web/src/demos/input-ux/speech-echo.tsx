...
export default function SpeechEcho() {
  ...
  return (
    <DemoPage
      ...
      maxWidth="4xl"
    >
      <div className="flex flex-col bg-slate-950 text-slate-100 border border-slate-800 rounded-lg overflow-hidden" style={{ height: '70vh' }}>
        <div className="border-b border-slate-800 px-4 py-2 flex items-center gap-4">
          <span className="text-xs text-slate-500">Speak → transcribe → echo back via TTS</span>
