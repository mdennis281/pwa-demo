 ...
 * PAGE DEMO — Web Push.
 *
 * Wraps body in <DemoPage>. Ported 1:1 from routes/Push.tsx. Internal Row/Btn
 * helpers replaced with the shared Row/Btn from _shared/ui.
 */
...
import { Btn, Row } from '../_shared/ui';
...
export default function PushDemo() {
  ...
  return (
    <DemoPage
      id="push"
      title="Web Push"
      blurb="Subscribe and have the server push a notification — works even when the tab is closed."
    >
